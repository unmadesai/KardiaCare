...
public class PlaceDetails extends GetNearbyPlacesData {
    ...
    @Key
    protected UsageEvents.Event[] events;
    ...
    GetNearbyPlacesData gbd=new GetNearbyPlacesData();
    ...
    public UsageEvents.Event[] getEvents() {
        return events;
    }
